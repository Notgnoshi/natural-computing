...
same plot. \autoref{fig:prob1:iterated-hill-climbing-soltions} shows the results of the iterated
...
\begin{figure}[h]
    ...
    \caption{Solutions from multiple runs of the hill climbing
        algorithm}\label{fig:prob1:iterated-hill-climbing-soltions}
\end{figure}
