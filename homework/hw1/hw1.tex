...
was surprisingly tricky to implement, and especially so with Numpy arrays over the usual Python
lists due to missing functionality.
...
\todoinline{I have run out of motivation. I'll implement the PMX crossover and the stack encoding,
    but that's it.}
