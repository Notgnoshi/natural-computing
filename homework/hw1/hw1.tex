    ...
    \item If the position occupied by $j$ in $P_2$ has already been filled in $C_1$ by an element
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}[
                  ...
                  \draw[->] (P2-1-5) edge (P1-1-5) (P1-1-5.south) edge (P2-1-7.north) (P2-1-7) edge (P1-1-7) (P1-1-7.south) edge (P2-1-3.north);
                  ...
                  \end{scope}
              \end{tikzpicture}
              \caption{Step 3, find better uncopied elements}\label{fig:prob3:pmx-step-3}
          \end{figure}
    \item Once each of the uncopied portions of $P_2$'s sublist have been placed, fill the
          ...
          \begin{figure}[H]
              ...
              \begin{tikzpicture}[font=\ttfamily,
                  ...
                  \end{scope}
              \end{tikzpicture}
              \caption{Step 4, fill in the rest of $P_2$}\label{fig:prob3:pmx-step-4}
          \end{figure}
\end{enumerate}

The second child $C_2$ is created in the same manner, with parents swapped.

\subsubsection{Order Crossover (OX)}
\todoinline{I have run out of motivation. I'll implement the PMX crossover and the stack encoding, but that's it.}
