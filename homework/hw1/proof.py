...
trivially = [
    ...
    "If there is any fairness in the universe,",
...
clearly = random.choice(trivially)
print(
    clearly,
    "all swaps, insertions, displacements, and shuffles can be implemented as a sequence of inversions.",
)
